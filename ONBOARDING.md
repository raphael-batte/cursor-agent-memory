...
| `chats/projects/<slug>.md` | **Recent**, **`## Next step`** (forward pointer from transcript tail), optional **`[bootstrap]` Decisions** on first sync |
...
3. **Curate `## Next step`** if the heuristic missed the real forward pointer
