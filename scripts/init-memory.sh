...
echo "  4. Status: python3 $INSTALL_ROOT/scripts/memory-status.py --memory-home $MEMORY_HOME"
echo "  5. Verify: python3 $INSTALL_ROOT/scripts/verify-memory.py --memory-home $MEMORY_HOME"
echo
